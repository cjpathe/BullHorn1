...
<!-- Collect the nav links, forms, and other content for toggling -->
 ...
 <li><a href="Profile?userid=${user.bhuserid}&action=viewprofile"><img alt="${user.username}" src="${gravatarURL}" height="80" width="70"/>&nbsp;${user.username}</a></li>
 <% } %>
 <li class="dropdown">
 ...
 <li><a href="Profile?userid=${user.bhuserid }&action=editprofile">Edit Profile</a></li>
